  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1">
        <div className="rounded text-xs w-fit p-[1px] px-2 text-green-600 bg-green-50">10 min</div>
        <div>
      ...
      <div className="w-fit gap-1 px-2 lg:px-0 text-sm lg:text-base">{data.unit}</div>
